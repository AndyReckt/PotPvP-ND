...
import static net.frozenorb.potpvp.match.MatchEndReason.DURATION_LIMIT_EXCEEDED;
import static net.frozenorb.potpvp.match.MatchEndReason.FORCEFULLY_TERMINATED;
