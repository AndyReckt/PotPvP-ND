...
abstract class Button {
    ...
    open fun getButtonItem(player: Player): ItemStack {
        val buttonItem =
            ItemStack(getMaterial(player), getAmount(player), getDamageValue(player).toShort())
        ...
        if (meta != null) {
            ...
            meta.lore = description.stream().map { line -> ChatColor.translateAlternateColorCodes('&', line) }
