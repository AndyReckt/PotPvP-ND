...
class Cuboid : Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    val center: Location
        get() {
            ...
            return Location(
                this.world,
                this.lowerX + (x1 - this.lowerX) / 2.0,
                this.lowerY + (y1 - this.lowerY) / 2.0,
                this.lowerZ + (z1 - this.lowerZ) / 2.0
            )
        }
    ...
    inner class CuboidIterator(private val w: World, x1: Int, y1: Int, z1: Int, x2: Int, y2: Int, z2: Int) :
        Iterator<Block> {
