...
extends Button {
    ...
    public String getName(Player player) {
        return (Object)ChatColor.DARK_PURPLE + this.parameter.getDisplayName();
    }
    ...
    public List<String> getDescription(Player player) {
        ...
        for (GameParameterOption option : this.parameter.getOptions()) {
            if (option.equals(this.selectedOption)) {
                toReturn.add((Object)ChatColor.GREEN + "\u00bb " + (Object)ChatColor.GRAY + option.getDisplayName());
                continue;
            }
            toReturn.add((Object)ChatColor.GRAY + option.getDisplayName());
        }
        return toReturn;
    }
