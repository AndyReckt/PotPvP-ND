...
class T4gGameEventLogic(game: com.qrakn.morpheus.game.Game) : LastManStandingGameEventLogic(game) {
    ...
    override fun start() {
        ...
        startTask = startEvent.runTaskTimerAsynchronously(PotPvPSI.getInstance(), 0L, 20L)
    ...
    fun startGame() {
        ...
        roundTask = roundRunnable.runTaskTimerAsynchronously(PotPvPSI.getInstance(), 0, 20L);
    }
    ...
    fun blastEveryone() {
        ...
        if (getRemainingParticipants().size <= 1) {
            ...
            }.runTaskLater(PotPvPSI.getInstance(), 40L)
